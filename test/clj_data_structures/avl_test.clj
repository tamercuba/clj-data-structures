...
(deftest insert-test
  (testing "tree is balanced after every insert"
    (is (avl/balanced? (avl/make [5 4 3 10 9 11]))))
...
(deftest balanced?-test
  ...
  (testing "single node is balanced"
    (is (avl/balanced? (avl/make [5]))))

  (testing "avl tree is always balanced after inserts"
    (is (avl/balanced? (avl/make [5 4 3 10 9 11 1 2]))))
...
(deftest remove-test
  ...
  (testing "tree is balanced after removing a leaf"
    (is (avl/balanced? (-> (avl/make [5 3 7 2 4]) (avl/remove 2)))))
  ...
  (testing "removal triggers rebalance"
    (is (avl/balanced? (-> (avl/make [5 3 7 2 4]) (avl/remove 7)))))
